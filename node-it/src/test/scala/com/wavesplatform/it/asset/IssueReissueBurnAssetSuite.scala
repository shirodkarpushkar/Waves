...
class IssueReissueBurnAssetSuite extends BaseSuite {
  ...
  "State changes" - {
    ...
    "rollback works" in {
      ...
      assertApiError(miner.assetsDetails(assetB), CustomValidationError("Failed to get description of the asset"))
      assertApiError(miner.assetsDetails(assetNft), CustomValidationError("Failed to get description of the asset"))
